...
# Exercise-2 TODOs:
    ...
    ros_cloud_objects_filtered = outlier_filter.filter()

    # TODO: Voxel Grid Downsampling
    vox = ros_cloud_objects_filtered.make_voxel_grid_filter()
    LEAF_SIZE = 0.01
